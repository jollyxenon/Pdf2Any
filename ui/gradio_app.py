...
def launch_gui(start_conversion_batch_fn):
    def convert_pdf_ui(input_files, output_dir_input, api_key, out_formats, pandoc_network, formula_mode, max_pages):
        if not input_files:
    ...
    with gr.Blocks(title="PdfEpubConverter", theme=gr.themes.Soft()) as demo:
        ...
        convert_btn.click(
            fn=convert_pdf_ui,
            inputs=[pdf_input, out_dir_input, api_key_input, out_format, pandoc_network, formula_mode, max_pages_input],
